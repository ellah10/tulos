...
import UnvailableWear from "../components/UnvailableWear";
...
const categories = ["featured", "new", "accessories", "t-shirt", "men"];

function Accessories() {
  const [selectedCategory, setSelectedCategory] = useState("accessories");

  const filteredWears = Wears.filter(
    (wear) => wear.tag && wear.tag.includes(selectedCategory)
  );

  return (
    <div className="Featured-container">
      <h3>
        Products by Category: <span>accessories</span>
      </h3>
      <div className="featured-container-items">
      ...
      <div className="wear-container">
        <div className="wear-item">
          {filteredWears.length > 0 ? (
            filteredWears.map((wear) => <WearCard key={wear.id} wear={wear} />)
          ) : (
